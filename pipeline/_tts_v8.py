"""One-shot TTS driver for Video 8 — writes voiceover.mp3 + voiceover.srt
...
V8 = r"C:\Users\ninja\Downloads\X Colab Automation\Royal\Video 8"
work = os.path.join(V8, "temp_render_workspace")
os.makedirs(work, exist_ok=True)
script = open(os.path.join(V8, "script.txt"), encoding="utf-8-sig").read()
...
import shutil
top_mp3 = os.path.join(V8, "voiceover.mp3")
top_srt = os.path.join(V8, "voiceover.srt")
