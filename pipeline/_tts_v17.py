"""One-shot TTS driver for Video 17."""
import os, sys
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
import config  # noqa: F401
from voiceover_engine import VoiceoverEngine

V17 = r"C:\Users\ninja\Downloads\X Colab Automation\Royal\Video 17"
work = os.path.join(V17, "temp_render_workspace")
os.makedirs(work, exist_ok=True)
script = open(os.path.join(V17, "script.txt"), encoding="utf-8-sig").read()
...
import shutil
top_mp3 = os.path.join(V17, "voiceover.mp3")
top_srt = os.path.join(V17, "voiceover.srt")
