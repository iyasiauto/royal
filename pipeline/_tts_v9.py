"""One-shot TTS driver for Video 9."""
import os, sys
...
V9 = ("C:\\Users\\ninja\\Downloads\\X Colab Automation\\Royal\\"
      "Video 9 (Meghan BREAKS DOWN as Princess Anne BLOCKS Her From "
      "Taking Archie & Lilibet Out of UK!)")
work = os.path.join(V9, "temp_render_workspace")
os.makedirs(work, exist_ok=True)
script = open(os.path.join(V9, "script.txt"), encoding="utf-8-sig").read()
...
import shutil
top_mp3 = os.path.join(V9, "voiceover.mp3")
top_srt = os.path.join(V9, "voiceover.srt")
