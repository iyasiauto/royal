"""One-shot TTS driver for Video 11."""
import os, sys
...
V11 = r"C:\Users\ninja\Downloads\X Colab Automation\Royal\Video 11"
work = os.path.join(V11, "temp_render_workspace")
os.makedirs(work, exist_ok=True)
script = open(os.path.join(V11, "script.txt"), encoding="utf-8-sig").read()
...
import shutil
top_mp3 = os.path.join(V11, "voiceover.mp3")
top_srt = os.path.join(V11, "voiceover.srt")
