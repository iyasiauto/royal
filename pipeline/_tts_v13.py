"""One-shot TTS driver for Video 13."""
import os, sys
...
V13 = r"C:\Users\ninja\Downloads\X Colab Automation\Royal\Video 13"
work = os.path.join(V13, "temp_render_workspace")
os.makedirs(work, exist_ok=True)
script = open(os.path.join(V13, "script.txt"), encoding="utf-8-sig").read()
...
import shutil
top_mp3 = os.path.join(V13, "voiceover.mp3")
top_srt = os.path.join(V13, "voiceover.srt")
