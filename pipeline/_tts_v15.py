"""One-shot TTS driver for Video 15."""
import os, sys
sys.path.insert(0, os.path.dirname(os.path.abspath(__file__)))
import config  # noqa: F401
from voiceover_engine import VoiceoverEngine

V15 = r"C:\Users\ninja\Downloads\X Colab Automation\Royal\Video 15"
work = os.path.join(V15, "temp_render_workspace")
os.makedirs(work, exist_ok=True)
script = open(os.path.join(V15, "script.txt"), encoding="utf-8-sig").read()
...
import shutil
top_mp3 = os.path.join(V15, "voiceover.mp3")
top_srt = os.path.join(V15, "voiceover.srt")
