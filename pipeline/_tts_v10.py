"""One-shot TTS driver for Video 10."""
import os, sys
...
V10 = ("C:\\Users\\ninja\\Downloads\\X Colab Automation\\Royal\\"
       "Video 10 (Harry & Meghan FLEEING Back to USA After SECRET "
       "UK Documentary Shoot Gets Them BANNED!)")
work = os.path.join(V10, "temp_render_workspace")
os.makedirs(work, exist_ok=True)
script = open(os.path.join(V10, "script.txt"), encoding="utf-8-sig").read()
...
import shutil
top_mp3 = os.path.join(V10, "voiceover.mp3")
top_srt = os.path.join(V10, "voiceover.srt")
